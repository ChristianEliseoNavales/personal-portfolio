                      ...
                      <div className="contact-info-card">
                          ...
                          <div className="row mb-2">
                              ...
                              <div className="col-10 ">
                                  <h6 className="d-inline">Phone : <br></br> <span className="text-muted">+ (123) 456-789</span></h6>
                              </div>
                          </div>
                          <div className="row mb-2">
                              <div className="col-1 pt-1 mr-1">
                              ...
                              <div className="col-10">
                                  <h6 className="d-inline">Address :<br></br> <span className="text-muted">12345 Fake ST NoWhere AB Country.</span></h6>
                              </div>
                          </div>
                          <div className="row mb-2">
                              <div className="col-1 pt-1 mr-1">
                              ...
                              <div className="col-10">
                                  <h6 className="d-inline">Email :<br></br> <span className="text-muted">info@website.com</span></h6>
                              </div>
                          </div>
      ...
      <footer className="footer py-3">
        <div className="container">
          <p className="small mb-0 text-light">
            &copy; Created With <i className="ti-heart text-danger" /> By{" "}<a href="http://devcrud.com" target="_blank" rel="noopener noreferrer"><span className="text-danger" title="Bootstrap 4 Themes and Dashboards">DevCRUD</span></a>
          </p>
        </div>
      </footer>
    </>
